		...
		<div class="artBg">
			<div class="title-bar-dark">
				<p>
					...
					<button  data-dismiss="modal" class="btn btn-light btn-xs closePopUp"><span data-dismiss="modal" class="closePopUp fa fa-angle-left" style="cursor:pointer;"></span> Back to Subjects</button>
					&nbsp; &nbsp; &nbsp; &nbsp;
					<br>
